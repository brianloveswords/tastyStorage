...
(function(l,j,f){function k(b){function c(){if(this instanceof arguments.callee)return new k(arguments[0]);if(arguments.length==0)return d.a();if(arguments.length==1)return d.getItem(arguments[0]);if(arguments.length==2)return d.setItem(arguments[0],arguments[1])}if(!(this instanceof arguments.callee))return new k(b);b=b||"local";var e=l[b+"Storage"],d=null;d=typeof Storage!=="undefined"&&Storage.prototype.getItem&&e instanceof Storage?m(e):n(b);for(var h in d)if(d.hasOwnProperty(h))c[h]=d[h];return c}
function m(b){return{"interface":"DOMStorage",clear:b.clear,removeItem:b.removeItem,setItem:function(c,e){return b.setItem(c,f.stringify(e))},getItem:function(c){return f.parse(b.getItem(c))},len:function(){return b.length}}}function n(b){function c(a){a=f.stringify(a);return encodeURIComponent(a)}if(!f||!f.stringify||!f.parse)throw Error("tastystorage.js: Expecting a JSON object with stringify() and parse() methods.");var e=b+"Storage",d=RegExp(e+"=([^;]*)"),h=b!=="session"&&";expires=Tue, 13 Aug 2100 07:30:00 UTC"||
"",g=function(){var a=j.cookie.match(d);return(a=decodeURIComponent(a&&a[1]||""))&&f.parse(a)||{}}();return{"interface":"document.cookie",clear:function(){j.cookie=e+"=null;expires=Tue, 13 Aug 1985 07:30:00 UTC"},getItem:function(a){return g[a]},setItem:function(a,i){g[a]=i;j.cookie=e+"="+c(g)+h;return i},removeItem:function(a){delete g[a];j.cookie=e+"="+c(g)+h},len:function(){var a=0,i;for(i in g)g.hasOwnProperty(i)&&(a+=1);return a}}}l.tastyStorage=new k("local")})(this,this.document,JSON);
