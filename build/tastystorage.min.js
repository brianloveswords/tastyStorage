...
n(b);for(var h in d)if(d.hasOwnProperty(h))c[h]=d[h];return c}function m(b){return{"interface":"DOMStorage",clear:function(){b.clear()},removeItem:function(c){b.removeItem(c)},setItem:function(c,e){return b.setItem(c,f.stringify(e))},getItem:function(c){return f.parse(b.getItem(c))},len:function(){return b.length}}}function n(b){function c(a){a=f.stringify(a);return encodeURIComponent(a)}if(!f||!f.stringify||!f.parse)throw Error("tastystorage.js: Expecting a JSON object with stringify() and parse() methods.");
var e=b+"Storage",d=RegExp(e+"=([^;]*)"),h=b!=="session"&&";expires=Tue, 13 Aug 2100 07:30:00 UTC"||"",g=function(){var a=j.cookie.match(d);return(a=decodeURIComponent(a&&a[1]||""))&&f.parse(a)||{}}();return{"interface":"document.cookie",clear:function(){j.cookie=e+"=null;expires=Tue, 13 Aug 1985 07:30:00 UTC"},getItem:function(a){return g[a]},setItem:function(a,i){g[a]=i;j.cookie=e+"="+c(g)+h;return i},removeItem:function(a){delete g[a];j.cookie=e+"="+c(g)+h},len:function(){var a=0,i;for(i in g)g.hasOwnProperty(i)&&
(a+=1);return a}}}l.tastyStorage=new k("local")})(this,this.document,JSON);
