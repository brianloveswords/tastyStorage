...
(function(l,j,f){function k(b){function d(){if(this instanceof arguments.callee)return new k(arguments[0]);if(arguments.length==0)return c.a();if(arguments.length==1)return c.getItem(arguments[0]);if(arguments.length==2){if(arguments[1]===null)return c.removeItem(arguments[0]);return c.setItem(arguments[0],arguments[1])}}if(!(this instanceof arguments.callee))return new k(b);b=b||"local";var e=l[b+"Storage"],c=null;c=typeof Storage!=="undefined"&&Storage.prototype.getItem&&e instanceof Storage?m(e):
n(b);for(var h in c)if(c.hasOwnProperty(h))d[h]=c[h];return d}function m(b){return{"interface":"DOMStorage",clear:b.clear,removeItem:b.removeItem,setItem:function(d,e){return b.setItem(d,f.stringify(e))},getItem:function(d){return f.parse(b.getItem(d))},len:function(){return b.length}}}function n(b){function d(a){a=f.stringify(a);return encodeURIComponent(a)}if(!f||!f.stringify||!f.parse)throw Error("tastystorage.js: Expecting a JSON object with stringify() and parse() methods.");var e=b+"Storage",
c=RegExp(e+"=([^;]*)"),h=b!=="session"&&";expires=Tue, 13 Aug 2100 07:30:00 UTC"||"",g=function(){var a=j.cookie.match(c);return(a=decodeURIComponent(a&&a[1]||""))&&f.parse(a)||{}}();return{"interface":"document.cookie",clear:function(){j.cookie=e+"=null;expires=Tue, 13 Aug 1985 07:30:00 UTC"},getItem:function(a){return g[a]},setItem:function(a,i){g[a]=i;j.cookie=e+"="+d(g)+h;return i},removeItem:function(a){delete g[a];j.cookie=e+"="+d(g)+h},len:function(){var a=0,i;for(i in g)g.hasOwnProperty(i)&&
